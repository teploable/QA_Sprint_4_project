...
public class FaqBlockPage {
    ...
    protected final By questionsHeader = By.className("Home_FourPart__1uthg");//Заголовок с вопросами
    protected final String questionsAccordionHeading = "accordion__heading-";//Базовое наименование класса вопроса без индекса
    protected final String answerAccordionPanel = "accordion__panel-";//Базовое наименование класса ответа без индекса
